...
library(xlsx)
write.xlsx(result, "Result_M1HermiT-Regression-Results-1.xlsx")
...
# And what is the ACCURACY ?
library(xlsx)
write.xlsx(result, "Result_M1HermiT-Regression-Results-2.xlsx")
...
# And what is the ACCURACY ?
library(xlsx)
write.xlsx(result, "Result_M1HermiT-Regression-Results-3.xlsx")
