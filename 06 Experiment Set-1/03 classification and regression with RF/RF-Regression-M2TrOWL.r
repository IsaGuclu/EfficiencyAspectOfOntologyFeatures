...
wk = loadWorkbook("Data_M2TrOWL.xlsx") 
...
library(xlsx)
write.xlsx(result, "Result_M2TrOWL-Regression-Results-1.xlsx")
...
# And what is the ACCURACY ?
library(xlsx)
write.xlsx(result, "Result_M2TrOWL-Regression-Results-2.xlsx")
...
# And what is the ACCURACY ?
library(xlsx)
write.xlsx(result, "Result_M2TrOWL-Regression-Results-3.xlsx")
