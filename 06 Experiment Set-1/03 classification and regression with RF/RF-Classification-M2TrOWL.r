...
library(xlsx)
write.xlsx(result, "Result_M2TrOWL-Classification-Results-1.xlsx")
...
# And what is the ACCURACY ?
library(xlsx)
write.xlsx(result, "Result_M2TrOWL-Classification-Results-2.xlsx")
...
# And what is the ACCURACY ?
library(xlsx)
write.xlsx(result, "Result_M2TrOWL-Classification-Results-3.xlsx")
