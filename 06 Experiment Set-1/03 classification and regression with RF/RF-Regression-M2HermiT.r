...
wk = loadWorkbook("Data_M2HermiT.xlsx") 
data = readWorksheet(wk, sheet="Regression")
...
for (i in 1:k){
  ...
  mymodel <- randomForest(TotalWs ~ ., data = trainingset, ntree = 500)
...
library(xlsx)
write.xlsx(result, "Result_M2HermiT-Regression-Results-1.xlsx")
...
# And what is the ACCURACY ?
library(xlsx)
write.xlsx(result, "Result_M2HermiT-Regression-Results-2.xlsx")
...
# And what is the ACCURACY ?
library(xlsx)
write.xlsx(result, "Result_M2HermiT-Regression-Results-3.xlsx")
