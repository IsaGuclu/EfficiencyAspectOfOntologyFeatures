...
wk = loadWorkbook("Data_M1TrOWL.xlsx") 
...
library(xlsx)
write.xlsx(result, "Result_M1TrOWL-Regression-Results-1.xlsx")
...
# And what is the ACCURACY ?
library(xlsx)
write.xlsx(result, "Result_M1TrOWL-Regression-Results-2.xlsx")
...
# And what is the ACCURACY ?
library(xlsx)
write.xlsx(result, "Result_M1TrOWL-Regression-Results-3.xlsx")
