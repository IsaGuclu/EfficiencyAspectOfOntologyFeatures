...
public class TBoxClassification {
	...
	public static void main(String[] args) {
		...
		// Logs of Execution
		File outFile = new File("Jcel_Classification_NanoSecs.tsv"); // dFilePath + File.separator + 
		PrintWriter out = null;

		// Logs of Errors
		File errorFile = new File("Jcel_Exceptions.tsv"); // dFilePath + File.separator + 
		...
		try {
			...
			// Create an Jcel reasoner.
			JcelReasonerFactory relfactory = new JcelReasonerFactory();
