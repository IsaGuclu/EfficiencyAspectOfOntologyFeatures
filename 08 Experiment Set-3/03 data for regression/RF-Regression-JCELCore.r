...
wk = loadWorkbook("Data_JCELCore.xlsx") 
...
library(xlsx)
write.xlsx(result, "Result_JCELCore-Regression-1.xlsx")
...
library(xlsx)
write.xlsx(result, "Result_JCELCore-Regression-2.xlsx")
...
library(xlsx)
write.xlsx(result, "Result_JCELCore-Regression-3.xlsx")
