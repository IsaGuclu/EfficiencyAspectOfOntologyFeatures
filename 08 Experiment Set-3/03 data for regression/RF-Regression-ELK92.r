...
wk = loadWorkbook("Data_ELK92.xlsx") 
...
library(xlsx)
write.xlsx(result, "Result_ELK92-Regression-1.xlsx")
...
library(xlsx)
write.xlsx(result, "Result_ELK92-Regression-2.xlsx")
...
library(xlsx)
write.xlsx(result, "Result_ELK92-Regression-3.xlsx")
