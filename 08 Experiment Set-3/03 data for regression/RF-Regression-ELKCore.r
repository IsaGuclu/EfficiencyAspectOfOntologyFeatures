...
wk = loadWorkbook("Data_ELKCore.xlsx") 
...
library(xlsx)
write.xlsx(result, "Result_ELKCore-Regression-1.xlsx")
...
library(xlsx)
write.xlsx(result, "Result_ELKCore-Regression-2.xlsx")
...
library(xlsx)
write.xlsx(result, "Result_ELKCore-Regression-3.xlsx")
