...
wk = loadWorkbook("Data_TrOWLCore.xlsx") 
...
for (i in 1:k){
  ...
  mymodel <- randomForest(Classification ~ ., data = trainingset, ntree = 500)
...
library(xlsx)
write.xlsx(result, "Result_TrOWLCore-Regression-1.xlsx")
...
library(xlsx)
write.xlsx(result, "Result_TrOWLCore-Regression-2.xlsx")
...
library(xlsx)
write.xlsx(result, "Result_TrOWLCore-Regression-3.xlsx")
