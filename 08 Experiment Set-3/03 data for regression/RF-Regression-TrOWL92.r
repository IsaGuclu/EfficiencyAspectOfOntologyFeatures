...
wk = loadWorkbook("Data_TrOWL92.xlsx") 
...
library(xlsx)
write.xlsx(result, "Result_TrOWL92-Regression-1.xlsx")
...
library(xlsx)
write.xlsx(result, "Result_TrOWL92-Regression-2.xlsx")
...
library(xlsx)
write.xlsx(result, "Result_TrOWL92-Regression-3.xlsx")
