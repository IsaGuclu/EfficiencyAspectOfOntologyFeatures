...
wk = loadWorkbook("Data_JCEL92.xlsx") 
...
library(xlsx)
write.xlsx(result, "Result_JCEL92-Regression-1.xlsx")
...
library(xlsx)
write.xlsx(result, "Result_JCEL92-Regression-2.xlsx")
...
library(xlsx)
write.xlsx(result, "Result_JCEL92-Regression-3.xlsx")
