...
wk = loadWorkbook("DataCore_TrOWL356.xlsx") 
...
for (i in 1:k){
  ...
  mymodel <- randomForest(Materializing ~ ., data = trainingset, ntree = 500) 
...
library(xlsx)
write.xlsx(result, "ResultsCore-TrOWL356-1.xlsx")
...
# WHAT IS PREDICTED IN 10-FOLD CROS-VALIDATED RANDOM-FOREST REGRESSION And what is the ACCURACY ?
library(xlsx)
write.xlsx(result, "ResultsCore-TrOWL356-2.xlsx")
detach("package:xlsx", TRUE)
...
# WHAT IS PREDICTED IN 10-FOLD CROS-VALIDATED RANDOM-FOREST REGRESSION And what is the ACCURACY ?
library(xlsx)
write.xlsx(result, "ResultsCore-TrOWL356-3.xlsx")
detach("package:xlsx", TRUE)
