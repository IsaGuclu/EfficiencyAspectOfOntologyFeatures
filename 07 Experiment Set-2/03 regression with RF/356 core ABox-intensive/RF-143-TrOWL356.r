...
wk = loadWorkbook("Data143_TrOWL356.xlsx") 
...
library(xlsx)
write.xlsx(result, "Results143-TrOWL356-1.xlsx")
...
# WHAT IS PREDICTED IN 10-FOLD CROS-VALIDATED RANDOM-FOREST REGRESSION And what is the ACCURACY ?
library(xlsx)
write.xlsx(result, "Results143-TrOWL356-2.xlsx")
detach("package:xlsx", TRUE)
...
# WHAT IS PREDICTED IN 10-FOLD CROS-VALIDATED RANDOM-FOREST REGRESSION And what is the ACCURACY ?
library(xlsx)
write.xlsx(result, "Results143-TrOWL356-3.xlsx")
detach("package:xlsx", TRUE)
