...
wk = loadWorkbook("Data92_ELK356.xlsx") 
...
library(xlsx)
write.xlsx(result, "Results92-ELK356-1.xlsx")
...
# WHAT IS PREDICTED IN 10-FOLD CROS-VALIDATED RANDOM-FOREST REGRESSION And what is the ACCURACY ?
library(xlsx)
write.xlsx(result, "Results92-ELK356-2.xlsx")
detach("package:xlsx", TRUE)
...
# WHAT IS PREDICTED IN 10-FOLD CROS-VALIDATED RANDOM-FOREST REGRESSION And what is the ACCURACY ?
library(xlsx)
write.xlsx(result, "Results92-ELK356-3.xlsx")
detach("package:xlsx", TRUE)
