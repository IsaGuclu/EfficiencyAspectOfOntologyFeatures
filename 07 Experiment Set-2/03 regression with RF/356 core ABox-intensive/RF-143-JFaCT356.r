...
wk = loadWorkbook("Data143_JFaCT356.xlsx") 
...
library(xlsx)
write.xlsx(result, "Results143-JFaCT356-1.xlsx")
...
# WHAT IS PREDICTED IN 10-FOLD CROS-VALIDATED RANDOM-FOREST REGRESSION And what is the ACCURACY ?
library(xlsx)
write.xlsx(result, "Results143-JFaCT356-2.xlsx")
detach("package:xlsx", TRUE)
...
# WHAT IS PREDICTED IN 10-FOLD CROS-VALIDATED RANDOM-FOREST REGRESSION And what is the ACCURACY ?
library(xlsx)
write.xlsx(result, "Results143-JFaCT356-3.xlsx")
detach("package:xlsx", TRUE)
