...
wk = loadWorkbook("Data_ELK3858.xlsx") 
data = readWorksheet(wk, sheet="ELK3858")
...
library(xlsx)
write.xlsx(result, "Results-ELK3858-1.xlsx")
...
# WHAT IS PREDICTED IN 10-FOLD CROS-VALIDATED RANDOM-FOREST REGRESSION And what is the ACCURACY ?
library(xlsx)
write.xlsx(result, "Results-ELK3858-2.xlsx")
detach("package:xlsx", TRUE)
...
# WHAT IS PREDICTED IN 10-FOLD CROS-VALIDATED RANDOM-FOREST REGRESSION And what is the ACCURACY ?
library(xlsx)
write.xlsx(result, "Results-ELK3858-3.xlsx")
detach("package:xlsx", TRUE)
