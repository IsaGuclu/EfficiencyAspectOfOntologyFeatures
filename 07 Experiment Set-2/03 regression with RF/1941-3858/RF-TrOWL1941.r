...
wk = loadWorkbook("Data_TrOWL1941.xlsx") 
data = readWorksheet(wk, sheet="TrOWL1941")
...
library(xlsx)
write.xlsx(result, "Results-TrOWL1941-1.xlsx")
...
# WHAT IS PREDICTED IN 10-FOLD CROS-VALIDATED RANDOM-FOREST REGRESSION And what is the ACCURACY ?
library(xlsx)
write.xlsx(result, "Results-TrOWL1941-2.xlsx")
detach("package:xlsx", TRUE)
...
# WHAT IS PREDICTED IN 10-FOLD CROS-VALIDATED RANDOM-FOREST REGRESSION And what is the ACCURACY ?
library(xlsx)
write.xlsx(result, "Results-TrOWL1941-3.xlsx")
detach("package:xlsx", TRUE)
