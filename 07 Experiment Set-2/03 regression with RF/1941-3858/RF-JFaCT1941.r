...
wk = loadWorkbook("Data_JFaCT1941.xlsx") 
data = readWorksheet(wk, sheet="JFaCT1941")
...
library(xlsx)
write.xlsx(result, "Results-JFaCT1941-1.xlsx")
...
# WHAT IS PREDICTED IN 10-FOLD CROS-VALIDATED RANDOM-FOREST REGRESSION And what is the ACCURACY ?
library(xlsx)
write.xlsx(result, "Results-JFaCT1941-2.xlsx")
detach("package:xlsx", TRUE)
...
# WHAT IS PREDICTED IN 10-FOLD CROS-VALIDATED RANDOM-FOREST REGRESSION And what is the ACCURACY ?
library(xlsx)
write.xlsx(result, "Results-JFaCT1941-3.xlsx")
detach("package:xlsx", TRUE)
