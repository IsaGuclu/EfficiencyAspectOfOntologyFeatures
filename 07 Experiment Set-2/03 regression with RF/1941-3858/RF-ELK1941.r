...
wk = loadWorkbook("Data_ELK1941.xlsx") 
data = readWorksheet(wk, sheet="ELK1941")
...
library(xlsx)
write.xlsx(result, "Results-ELK1941-1.xlsx")
...
# WHAT IS PREDICTED IN 10-FOLD CROS-VALIDATED RANDOM-FOREST REGRESSION And what is the ACCURACY ?
library(xlsx)
write.xlsx(result, "Results-ELK1941-2.xlsx")
detach("package:xlsx", TRUE)
...
# WHAT IS PREDICTED IN 10-FOLD CROS-VALIDATED RANDOM-FOREST REGRESSION And what is the ACCURACY ?
library(xlsx)
write.xlsx(result, "Results-ELK1941-3.xlsx")
detach("package:xlsx", TRUE)
